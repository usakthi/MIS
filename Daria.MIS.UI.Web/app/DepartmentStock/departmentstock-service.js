(function () {
    ...
    angular
        .module('departmentstockService', ['ngResource'])        
        .factory('DepartmentStockDataService', DepartmentStockDataService);

    DepartmentStockDataService.$inject = ['$http', '$q'];

    function DepartmentStockDataService($http, $q) {
        var baseUrl = '/departmentstock/';
        return {
