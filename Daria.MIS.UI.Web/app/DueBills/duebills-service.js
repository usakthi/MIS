(function () {
    ...
    angular
        .module('duebillsService', ['ngResource'])
    ...
    function StockAdjustmentDataService($http, $q) {
        var baseUrl = '/duebills/';
        return {
            getDueBillsList: function () {
                // Get the deferred object
                var deferred = $q.defer();
                // Initiates the AJAX call
                $http({ method: 'POST', url: baseUrl + 'GetDueBillsList' }).success(deferred.resolve).error(deferred.reject);
            ...
            getDueBillInfo: function (userInfo) {

                var deferred = $q.defer();                
                $http({ method: 'POST', url: baseUrl + 'GetDueBillItems', data: { no: userInfo } }).success(deferred.resolve).error(deferred.reject);
                return deferred.promise;
            }
