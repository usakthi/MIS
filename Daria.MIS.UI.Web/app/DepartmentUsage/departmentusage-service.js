(function () {
    ...
    angular
        .module('departmentusageService', ['ngResource'])        
    ...
    function IndentBillDataService($http, $q) {
        ...
        return {
            ...
            getIndentInfo: function (pId) {
                ...
                var deferred = $q.defer();                
                $http({ method: 'POST', url: baseUrl + 'GetDepartmentItems', data: { id: pId } }).success(deferred.resolve).error(deferred.reject);
                return deferred.promise;
            },
