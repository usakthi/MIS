...
{
    public interface ITenantindentreceivable
    {
        int PharmacyId { get; set; }
        string PharmacyIdEnc { get; set; }
    }
    public class IndentReceivable : ITenantindentreceivable
    {
        ...
        public List<IndentReceivableItem> IndentReceivableItems { get; set; }
    ...
    public class IndentReceivableItem
    {
        public long Id { get; set; }
        public int PharmacyId { get; set; }
