...
{
    public interface ITenantSalesReturn
    {
        int PharmacyId { get; set; }
        string PharmacyIdEnc { get; set; }
    }
    public class SalesReturn : ITenantSalesReturn
    {
        ...
        public List<SalesReturnItem> SalesRetItems { get; set; }
