...
{
    public interface ITenantindentbill
    {
        int PharmacyId { get; set; }
        string PharmacyIdEnc { get; set; }
    }
    public class IndentBill : ITenantindentbill
    {
        ...
        public List<IndentBillItem> IndentBillItems { get; set; }
