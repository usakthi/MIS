...
{
    public interface ITenantDepartmentusage
    {
        int PharmacyId { get; set; }
        string PharmacyIdEnc { get; set; }
    }
    public class DepartmentUsage : ITenantDepartmentusage
    {
        ...
        public List<DepartmentUsageItem> IndentBillItems { get; set; }
    ...
    public class DepartmentUsageItem
    {
        public long Id { get; set; }
        public int PharmacyId { get; set; }
