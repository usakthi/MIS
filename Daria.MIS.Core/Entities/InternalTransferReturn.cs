...
{
    public interface ITenantIntTransRet
    {
        int PharmacyId { get; set; }
        string PharmacyIdEnc { get; set; }
    }
    public class IntTransReturn : ITenantIntTransRet
    {
        ...
        public List<IntTransReturnItem> IntTransReturnItems { get; set; }
    ...
    public class IntTransReturnItem
    {
        public long Id { get; set; }
        public int PharmacyId { get; set; }
